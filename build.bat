...
set "warn=/wd4244 /wd5105 /wd4127 /wd4100 /wd4456 /wd4267"
...
set "link_param=/link /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /ENTRY:mainCRTStartup /NODEFAULTLIB:libcmt /LIBPATH:%lib_dir% raylib.lib opengl32.lib kernel32.lib shell32.lib user32.lib gdi32.lib winmm.lib"
